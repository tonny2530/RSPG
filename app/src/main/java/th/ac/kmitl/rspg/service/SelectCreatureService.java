...
public class SelectCreatureService {
    ...
    public static SelectCreatureResponse getCreature(SelectCreatureRequest request){
        SelectCreatureResponse response = null;
        String result = "";
        SoapObject soapObject = new SoapObject(NAMESPACE, MainConstant.SELECT_CREATURE);
        ...
        try {
            ...
            response = mapper.readValue(result, SelectCreatureResponse.class);
        }catch (Exception e) {
            e.printStackTrace();
        }
