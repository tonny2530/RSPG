...
public class CreatureListAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public CreatureListAdapter(List<BaseItem> itemList, Context context) {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == MainConstant.TYPE_CARD_VIEW) {
            v = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.creature_list, parent, false);
    ...
    public void onBindViewHolder(final BaseViewHolder holder, int position) {
        ...
        holder.setItemClickListener(new ItemClickListener() {
            ...
            public void onClick(View view, int position, boolean isLongClick) {
                if(isLongClick){
                    Toast.makeText(context,"Creature Long Click "+ finalCardViewItem.getItemId() + " : "+ finalCardViewItem.getText() ,Toast.LENGTH_SHORT).show();
                    Intent i = new Intent(context,CreatureActivity.class);
                    i.putExtra("creatureId",finalCardViewItem.getItemId());
                    context.startActivity(i);
                }
                else{
                    Toast.makeText(context,"Creature Click "+ finalCardViewItem.getItemId() + " : "+ finalCardViewItem.getText(),Toast.LENGTH_SHORT).show();
                    Intent i = new Intent(context,CreatureActivity.class);
                    i.putExtra("creatureId",finalCardViewItem.getItemId());
                    context.startActivity(i);
                }
