...
public class SelectPlantResponse {
    ...
    private List<SelectPictureResponse> picture = null;
    @JsonProperty("habitat")
    private List<HabitatResponse> habitat = null;
    @JsonIgnore
    ...
    @JsonProperty("culture_detail")
    public String getCultureDetail() {
        return cultureDetail;
    }

    @JsonProperty("culture_detail")
    public void setCultureDetail(String cultureDetail) {
    ...
    @JsonProperty("picture")
    public List<SelectPictureResponse> getPicture() {
        return picture;
    }

    @JsonProperty("picture")
    public void setPicture(List<SelectPictureResponse> picture) {
        this.picture = picture;
    }

    @JsonProperty("habitat")
    public List<HabitatResponse> getHabitat() {
        return habitat;
    }

    @JsonProperty("habitat")
    public void setHabitat(List<HabitatResponse> habitat) {
