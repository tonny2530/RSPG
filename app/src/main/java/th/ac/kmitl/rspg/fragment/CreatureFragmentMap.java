...
public class CreatureFragmentMap extends Fragment implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    public void onViewCreated(android.view.View view, android.os.Bundle savedInstanceState) {
        ...
        latitude_tv = (TextView) view.findViewById(R.id.creature_lat_textView);
        longitude_tv = (TextView) view.findViewById(R.id.creature_long_textView);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_add_creature_map, container, false);

        if (requestSinglePermission()) {
            //use SuppoprtMapFragment for using in fragment instead of activity  MapFragment = activity   SupportMapFragment = fragment
            mapFragment = (SupportMapFragment) getChildFragmentManager().findFragmentById(R.id.creature_map);
...
//            SupportMapFragment mapFragment = (SupportMapFragment) getChildFragmentManager().findFragmentById(R.id.creature_map);
            mapFragment.getMapAsync(this);
        } else {
