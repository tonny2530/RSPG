...
public class InsertPlantService {
    ...
    private final static String SOAP_ACTION = "http://tempuri.org/InsertPlant";
    ...
    private final static String PARAMETER_FLOWER_TIME = "flower_time";
    private final static String PARAMETER_FRUIT_TIME = "fruit_time";
    private final static String PARAMETER_PROPAGATION = "propagation";
    private final static String PARAMETER_CULTURE_DETAIL = "culture_detail";
    private final static String PARAMETER_OTHER = "other";
    private final static String PARAMETER_USER_ID  = "user_id ";

    public static InsertResponse insertPlant(InsertPlantRequest request){
        InsertResponse response = null;
        String result = "";

        SoapObject soapObject = new SoapObject(NAMESPACE, MainConstant.INSERT_PLANT);
        ...
        propertyInfo14.setName(PARAMETER_FLOWER_TIME);
        propertyInfo14.setValue(StringUtil.checkNullOrEmpty(request.getFlowerTime()));
        propertyInfo14.setType(String.class);

        soapObject.addProperty(propertyInfo14);

        PropertyInfo propertyInfo15 = new PropertyInfo();
        propertyInfo15.setName(PARAMETER_FRUIT_TIME);
        propertyInfo15.setValue(StringUtil.checkNullOrEmpty(request.getFruitTime()));
        propertyInfo15.setType(String.class);

        soapObject.addProperty(propertyInfo15);

        PropertyInfo propertyInfo16 = new PropertyInfo();
        propertyInfo16.setName(PARAMETER_PROPAGATION);
        propertyInfo16.setValue(StringUtil.checkNullOrEmpty(request.getPropagation()));
        propertyInfo16.setType(String.class);

        soapObject.addProperty(propertyInfo16);

        PropertyInfo propertyInfo17 = new PropertyInfo();
        propertyInfo17.setName(PARAMETER_CULTURE_DETAIL);
        propertyInfo17.setValue(StringUtil.checkNullOrEmpty(request.getCultureDetail()));
