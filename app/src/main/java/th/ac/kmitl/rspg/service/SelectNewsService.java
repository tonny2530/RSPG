...
public class SelectNewsService {
    ...
    private final static String SOAP_ACTION = "http://tempuri.org/SelectNews";
    private final static String PARAMETER_LOG_USER_ID = "log_user_id";
    private final static String PARAMETER_ID = "id";

    public static SelectNewsResponse getNews(SelectNewsRequest request){
        SelectNewsResponse selectNewsResponse = null;
        String result = "";

        SoapObject soapObject = new SoapObject(NAMESPACE, MainConstant.SELECT_NEWS);
        ...
        try {
            ...
            selectNewsResponse = mapper.readValue(result, SelectNewsResponse.class);
