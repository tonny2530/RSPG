...
public class NewsListAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public NewsListAdapter(List<BaseItem> itemList, Context context) {
        ...
        final CardViewItem finalCardViewItem = cardViewItem;
            holder.setItemClickListener(new ItemClickListener() {
                ...
                public void onClick(View view, int position, boolean isLongClick) {
                    if(!"0".equalsIgnoreCase(finalCardViewItem.getItemId())){
                        ...
                        i.putExtra("newsId",finalCardViewItem.getItemId());
